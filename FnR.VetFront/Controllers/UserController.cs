...
namespace FnR.VetFront.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        {
            //var vet = db.Vets.Where(v => v.Username == HttpContext.User.Identity.Name).SingleOrDefault();
            int vetId = GetVetId();
            return View(db.Users.Include(r => r.Vet).Where(r => r.VetId == vetId).ToList());
        }
